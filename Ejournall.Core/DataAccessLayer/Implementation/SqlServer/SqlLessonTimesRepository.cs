...
{
    public class SqlLessonTimesRepository : ILessonTimeRepository
    {
        private readonly string connectionString;
        public SqlLessonTimesRepository(string connectionString)
        {
        ...
        public bool Delete(int Id)
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                string cmdText = $"Update LessonTimes Set status = 0 Where Id = {Id}";
        ...
        public List<LessonTime> GetAll()
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                string cmdText = "Select E.Id as LTID, E.StartTime, E.EndTime, L.Id as [LID],TS.ID as [TSID], " +
        ...
        public bool Insert(LessonTime entity)
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                con.Open();

                string cmdText = "Insert Into LessonTimes values(@LessonId, @StartTime, @EndTime, 1)";
        ...
        public bool Update(LessonTime entity)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
                string cmdText = "Update LessonTimes " +
                    "Set LessonId = @LessonId, StartTime = @StartTime, EndTime = @EndTime where id = @id";
